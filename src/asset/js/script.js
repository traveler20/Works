...
for (let i = 0; i < array_skill.length; i++) {
	...
	skill_content.querySelector(
		".js-skill_icon"
	).src = `./asset/img/skill/icon-${array_skill[i].skill_icon}.svg`;
...
for (let i = 0; i < array_feature.length; i++) {
	...
	feature_content.querySelector(
		".js-feature_img"
	).src = `./asset/img/feature/feature${array_feature[i].feature_img}.webp`;
...
for (let i = 0; i < array_work1.length; i++) {
	...
	work_content1.querySelector(
		".js-work_img"
	).src = `./asset/img/work/${array_work1[i].work_img}.webp`;
...
for (let i = 0; i < array_work2.length; i++) {
	...
	work_content2.querySelector(
		".js-work_img"
	).src = `./asset/img/work/${array_work2[i].work_img}.webp`;
...
for (let i = 0; i < array_work3.length; i++) {
	...
	work_content3.querySelector(
		".js-work_img"
	).src = `./asset/img/work/${array_work3[i].work_img}.webp`;
